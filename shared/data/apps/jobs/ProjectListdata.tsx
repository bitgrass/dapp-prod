interface ProjectListData {
  ...
  nftStats: {
    ...
    categories: {
      name: string;   // Standard, Premium, Legendary
      size: number;   // 100, 500, 1000
      current: number; // e.g. 0, 800, 400
      total: number;  // e.g. 2000, 800, 400
      status: string; // "Minted" | "Sold"
